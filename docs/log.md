...
## 2026-08-29
* **Update**: Session wrap — [HANDOFF](plans/okf-repo-docs/HANDOFF.md) phase 3 complete (event 6).
* **Creation**: Invariant [Code wins over wiki](concepts/code-wins.md).
* **Initialization**: Greenfield skeleton (`AGENTS.md`, `README.md`, bundle indexes).
